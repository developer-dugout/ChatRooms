    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, final int position)
    {
        ...
        else if (fromMessageType.equals("pdf") ||  fromMessageType.equals("docx"))
        {
            if (fromUserID.equals(messageSenderId))
            {
                ...
                Picasso.get()
                        .load("https://firebasestorage.googleapis.com/v0/b/chatrooms-50e4c.appspot.com/o/ChatRoom%20Images%2Ffile.png?alt=media&token=81588903-eb0b-4968-9409-7e79c6c5046f")
                    ...
                    else if (userMessagesList.get(position).getType().equals("image"))
                    {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int i)
                            {
                                ...
                                if (i == 1)
                                {
                                    Intent intent = new Intent(messageViewHolder.itemView.getContext(), ViewerImageActivity.class);
